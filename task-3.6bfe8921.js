...
})({"GLChk":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "15578bb26bfe8921";
"use strict";
...
},{}],"5AuyS":[function(require,module,exports,__globalThis) {
...
if (bookmarksLocalStorage !== null) {
    if (bookmarksLocalStorage.length !== 0) bookmarksLocalStorage.forEach((bookmark)=>{
        ...
        const changeBookmark = ()=>{
            ...
            input.addEventListener("keydown", (e)=>{
                if (e.code === "Enter") changeText();
            });
            posDiv.append(input);
        };
        const removeBookmark = ()=>{
            item.remove();
            (0, _lodashDefault.default).remove(bookmarks, (bookmark)=>bookmark.id === bookmarkData.id);
            changeBtn.removeEventListener("click", changeBookmark);
...
},{"lodash":"3qBDj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","uuid":"j4KJi"}]},["GLChk","5AuyS"], "5AuyS", "parcelRequire94c2")

//# sourceMappingURL=task-3.6bfe8921.js.map
