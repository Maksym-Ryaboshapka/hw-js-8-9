...
})({"7LnGz":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "377e862755b9820c";
"use strict";
...
},{}],"ad8QP":[function(require,module,exports,__globalThis) {
...
if (contactsLocalStorage !== null) {
    if (contactsLocalStorage.length !== 0) contactsLocalStorage.forEach((contact)=>{
        ...
        const removeContact = ()=>{
            item.remove();
            (0, _lodashDefault.default).remove(contacts, (contact)=>contact.id === contactData.id);
...
},{"lodash":"3qBDj","uuid":"j4KJi","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7LnGz","ad8QP"], "ad8QP", "parcelRequire94c2")

//# sourceMappingURL=task-4.55b9820c.js.map
