...
if (tasksLocalStorage !== null) {
    if (tasksLocalStorage.length !== 0) tasksLocalStorage.forEach((task)=>{
        ...
        const removeTask = (e)=>{
            item.remove();
            (0, _lodashDefault.default).remove(tasks, (task)=>task.id === taskData.id);
...
},{"lodash":"3qBDj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","uuid":"j4KJi"}]},["80cCk","1SICI"], "1SICI", "parcelRequire94c2")
